...
export default async function LandingLayout({ children }: LandingLayoutProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-white">
      <LandingNav hasSession={Boolean(user?.email)} />
      ...
      <footer className="fixed bottom-0 w-full bg-indigo-700 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl p-4">
          <div className="mx-auto flex max-w-xs items-center justify-center">
            <a
              href="https://twitter.com/mateussmohamed"
              target="_blank"
              rel="noreferrer"
              className="text-gray-300 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
            >
              <svg
                width="20"
                height="20"
            ...
            <a
              href="https://github.com/mateussmohamed"
              target="_blank"
              rel="noreferrer"
              className="m-4 text-gray-300 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
